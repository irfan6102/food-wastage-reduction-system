...
<h2 class="ml-4 pt-5">List of Organizers</h2>
</body>
<?php
session_start();
$organizer=  $_SESSION['username'];
  ...
  $count=0;
  // SQL QUERY
  $query = "SELECT  * from organizerdetail";
...
?>
  ...
  <div class="text-center bg-dark text-white" style="height: 80px; padding: 30px; margin-top: 480px;" >
