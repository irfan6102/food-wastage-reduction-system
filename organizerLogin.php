...
$password=$_POST['password'];
 ...
 $sql="SELECT * from organizerdetail where username='$username' and password='$password'";
    ...
    if($result->num_rows>0) 
     {
        ...
        header('location:organizerview.php');
}
   else{
...
<div class="login">
  <div class="container">
    ...
    <label>
<a href="organizerForgotPassword.php">Forgot password</a><br><br>
